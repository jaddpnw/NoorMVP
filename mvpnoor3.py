...
st.markdown(
    ...
    .noor {
        ...
        font-size: 60px;
        font-weight: 900;
        color: #FFD700; /* Noor stays bright yellow */
        margin: 0;
    }
    ...
    .caption {
        ...
        font-size: 14px;
        color: #FFD700; /* REMEMBRANCE yellow */
    ...
    .ai-guide {
        ...
        font-size: 16px;
        font-weight: 600;
        color: #FFC107; /* slightly more golden */
        margin-top: 10px; /* added spacing from caption */
        margin-bottom: 15px; /* extra space before Ask Noor text area */
        text-align: center;
    }
    </style>
